...
*/
 ...
 public enum ResponseCode {
    ...
    //sign error
    ARG_NO_APPID(10001, "appId不能为空"),
    ARG_APPID_VALID(10002, "appId值非法"),
    ARG_NO_VERSION(10003, "version不能为空"),
    ARG_VERSION_VALID(10004, "version值非法"),
    ARG_NO_UUID(10005, "uuid不能为空"),
    /*
